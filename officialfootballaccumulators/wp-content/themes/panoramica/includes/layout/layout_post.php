...
function cpotheme_post_pagination(){
	...
	//First Page Link
	if(1 == $current_page){
		$out .= '<span class="first_page">'.__('First Page', 'cpotheme').'</span>';
	}else{ 
		$out .= '<a class="page first_page" href="'.esc_url(get_pagenum_link(1)).'">'.__('First', 'cpotheme').'</a>';
	}
	...
	if($total_pages == $current_page){
		$out .= '<span class="first_page">'.__('Last Page', 'cpotheme').'</span>';
	}else{ 
		$out .= '<a class="page first_page" href="'.esc_url(get_pagenum_link($total_pages)).'">'.__('Last', 'cpotheme').'</a>';
	}
