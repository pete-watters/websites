...
<img src="images/bannerBlue.jpg" alt="Integra" usemap="#Map" align="center" border="0" height="158" width="780">
<map name="Map" id="Map">
				...
				<tr>
					<td class="myMenu" align="right">
						...
						<table width="100%"  class="rootVoices" cellspacing='0' cellpadding='0' border='0'><tr>
							...
							<td class="rootVoice {menu: 'empty'}" onclick="window.open('orderDemo.php','ww')">Demonstration</td>
...
<div id="menu_2" class="menu">
	...
	<a class="{menu: 'services_sub_menu_1', img: 'icon_14.png'}">7 - Day Support</a>
	<a class="{menu: 'services_sub_menu_2', img: 'icon_14.png'}">SLA</a>
</div>
...
<div id="integraPOS" class="menu">
	...
	<a href="../mb_carusel/carousel.html" class="{img: 'IntegraBall.png'}" >Epos </a> <!-- menuvoice with href-->
	<a href="../mb_carusel/carousel.html" class="{img: 'IntegraBall.png'}" >Main Till Functions </a> <!-- menuvoice with href-->
	<a href="../mb_carusel/carousel.html" class="{img: 'IntegraBall.png'}" >Margin Protection  </a> <!-- menuvoice with href-->
	<a href="../mb_carusel/carousel.html" class="{img: 'IntegraBall.png'}" >Stock Control</a> <!-- menuvoice with href-->
	<a href="../mb_carusel/carousel.html" class="{img: 'IntegraBall.png'}" >Integra Scan</a> <!-- menuvoice with href-->
