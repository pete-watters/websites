...
$args['opt_name'] = 'justblue';

//Custom menu icon
//$args['menu_icon'] = '';

//Custom menu title for options page - default is "Options"
$args['menu_title'] = __('JustBlue', 'nhp-opts');

//Custom Page Title for options page - default is "Options"
$args['page_title'] = __('JustBlue', 'nhp-opts');
...
$sections[] = array(
				...
				'fields' => array(
					...
					array(
						...
						'sub_desc' => __('Upload your logo <strong>(175 x 70 px)</strong> using the Upload Button or insert image URL.', 'nhp-opts')
						),
					array(
						'id' => 'mts_favicon',
						'type' => 'upload',
					...
					array(
						...
						'std' => '<a href="'.get_bloginfo('url').'/" title="'.get_bloginfo('description').'">'.get_bloginfo('name').'</a> Copyright &copy; '.date("Y")
						),
					array(
