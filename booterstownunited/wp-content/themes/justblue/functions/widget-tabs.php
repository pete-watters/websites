...
<a href='<?php the_permalink(); ?>' rel='nofollow'><img src="<?php echo $image[0]; ?>" alt="<?php the_title(); ?>"  width='65' height='50' class="wp-post-image" /></a>
<?php else: ?>
<a href='<?php the_permalink(); ?>' rel='nofollow'><img src="<?php echo get_template_directory_uri(); ?>/images/smallthumb.png" alt="<?php the_title(); ?>"  width='65' height='50' class="wp-post-image" /></a>
<?php endif; ?>
<div class="clear"></div>
</div>
 	<div class="info">
