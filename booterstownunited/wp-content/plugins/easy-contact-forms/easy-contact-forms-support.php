...
class EasyContactFormsSupport {
	...
	function getSupportPage() {
		...
		wp_enqueue_script('easy-contact-forms-html', '/wp-content/plugins/easy-contact-forms/easy-contact-formshtml.1.4.4.js', array(), false, true);

		wp_enqueue_script('easy-contact-forms-env', '/wp-content/plugins/easy-contact-forms/easy-contact-forms.env.1.4.4.js', array(), false, true);
