...
The Site User profile field allows connecting Easy Contact Forms user profiles with Wordpress user accounts.
...
* Ability to insert file upload links to contact form notification and confirmation email messages.
...
3. Open the contact form mailing list and add users who should receive notifications.
...
Maintenance release of version 1.4.3 - contact form radio group and select field bugs are fixed
