		...
		<?php   
			...
			endforeach;
				...
				<div class="box span4">
					...
					<h2 class="box-widget-title"><?php _e( 'iFeature Pro 5 Slider', 'cyberchimps' ); ?></h2>
					<p><?php _e( 'The New Touch Friendly iFeature Pro Slider now responds to any mobile touch device.', 'cyberchimps' ); ?></p>
				</div><!--end box1-->
