...
?>
<div class="panel <?php echo "columns-".$DYN_gridcolumns." "; echo $categories; ?>" data-id="id-<?php echo $data_id; ?>"  <?php if($DYN_galleryheight) { ?> style="height: <?php echo $DYN_galleryheight; ?>px" <?php } else { ?> style="height:435px;" <?php } ?>>

<?php if($DYN_groupgridcontent!="text") { ?>    

    <?php if($DYN_videotype) { // Check "Preview Image" field is completed ?>    
    
		<div class="container videotype <?php echo $DYN_shadowsize.' '.$DYN_imageeffect.' '.$DYN_cssclasses; ?>" <?php if($DYN_imageeffect=="shadowreflection" || $DYN_imageeffect=="reflection") { ?>style="padding-bottom:35px"<?php } ?> >
				...
				<div class="title-wrap" style="width:<?php echo $DYN_imgwidth; ?>px">	                  					
                    ...
                    <script type="text/javascript">
                      ...
                      jwplayer('<?php echo $slide_id; ?>').setup({
                        ...
                        <?php if($DYN_videoautoplay=="1") { ?>,
                        'events': {
                            'onReady': function() { this.stop().play(); },
                        }
                        <?php } ?>
                      });
...
<?php if($postcount==$DYN_gridcolumns) { $postcount="0"; } ?> 