<div class="formelement">
			...
			<div class="item">
						...
						<select name="<?php echo $value['id']; ?>" id="<?php echo $value['id']; ?>" class="select">
									...
									<option<?php if ( get_settings( $value['id'] ) == $op_val) { echo ' selected="selected"'; } elseif ($op_val == $value['std']) { echo ' selected="selected"'; } ?> value="<?php echo $op_val; ?>"><?php echo $option; ?></option>
									<?php } ?>
						</select>
						</div>
			</div>
